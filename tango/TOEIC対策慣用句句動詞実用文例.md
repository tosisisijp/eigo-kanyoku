...
# TOEIC対策：慣用句・句動詞 実用文例

**参照元**: [[句動詞#TOEIC対策：慣用句・句動詞一覧]]

以下の表は、TOEIC で頻出度が高い（優先度 95）慣用句・句動詞を、実際のビジネス文脈で使用できる例文とともに示したものです。Anki カード作成時のテンプレートとしても利用できます。
...
| 11 | **ahead of schedule** | 予定より早く | 慣用表現 | "The project was completed ahead of schedule." | プロジェクトは予定より早く完了しました。 | Part 7: 進捗報告 | **90** |
| 12 | **be in charge of** | ～を担当している | 慣用表現 | "Ms. Smith is in charge of marketing campaigns." | スミスさんがマーケティングキャンペーンを担当しています。 | Part 3: 組織説明 | **90** |
| 13 | **behind schedule** | 予定より遅れて | 慣用表現 | "The construction is running behind schedule." | 建設工事は予定より遅れています。 | Part 4: 工事通知 | **90** |
...
| 27 | **at your convenience** | ご都合の良い時に | 慣用表現 | "Please contact us at your convenience." | ご都合の良い時にご連絡ください。 | Part 7: メール文章 | **85** |
